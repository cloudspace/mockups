...
CanvasObject.prototype.mongo_path = function(canvas_object_id) { 
	canvas_object_id = canvas_object_id ? canvas_object_id : this.id;
	return 'pages.' + this.page.id + '.canvas_objects.' + canvas_object_id; 
};
...
// Requires the existance of a valid, up to date page object
// Params:
